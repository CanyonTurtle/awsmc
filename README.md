...
emcc src/game.c -o build/cart.wasm -s EXPORTED_FUNCTIONS="['_configure', '_update']" -s STACK_SIZE=8mb -Oz --no-entry -Wl,--import-memory,--initial-memory=67108864,--stack-first && bun run awsmc.ts bundle build/cart.wasm build/index.html
```
